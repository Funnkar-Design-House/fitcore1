...
## Project Overview
CheckInChaser is a gym management system built with React + TypeScript + Vite. Currently operates with **mock data** in [src/data/mockData.ts](../src/data/mockData.ts) while Supabase integration is set up but not yet connected.
